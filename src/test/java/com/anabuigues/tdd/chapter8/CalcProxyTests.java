...
public class CalcProxyTests {
	...
	public void setUp() throws Exception {
		...
		calcProxyWithLimits = new CalcProxy(new Validator(-10, 10),
				calculator);
	}
	...
	@Test
	public void argumentsExceedLimits() throws Exception {
		try {
	...
	@Test
	public void ArgumentsExceedLimitsInverse() throws Exception {
		try {
			calcProxyWithLimits.binaryOperation(OperationType.add, -30, -50);
			fail("This should fail as arguments exceed both limits");
		} catch (OverflowException oEx) {
	...
	@Test
	public void ValidateResultExceedingUpperLimit() throws Exception {
		try {
	...
	@Test
	public void ValidateResultExceedingLowerLimit() throws Exception {
		try {
